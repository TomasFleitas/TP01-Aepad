...
public class ProductoResource {
    ...
    public ResponseEntity<Producto> buscar(@PathVariable(required = false) Integer id) {
        return  new ResponseEntity<Producto>(this.productoService.buscarPorId(id), HttpStatus.OK);
    }
